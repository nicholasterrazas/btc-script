...
OP_1ADD                 = Opcode(label='OP_1ADD', category='arithmetic')
OP_1SUB                 = Opcode(label='OP_1SUB', category='arithmetic')
...
OP_NEGATE               = Opcode(label='OP_NEGATE', category='arithmetic')
OP_ABS                  = Opcode(label='OP_ABS', category='arithmetic')
OP_NOT                  = Opcode(label='OP_NOT', category='arithmetic')
OP_0NOTEQUAL            = Opcode(label='OP_0NOTEQUAL', category='arithmetic')
OP_ADD                  = Opcode(label='OP_ADD', category='arithmetic')
OP_SUB                  = Opcode(label='OP_SUB', category='arithmetic')
OP_MUL                  = Opcode(label='OP_MUL', category='arithmetic', disabled=True)
OP_DIV                  = Opcode(label='OP_DIV', category='arithmetic', disabled=True)
OP_MOD                  = Opcode(label='OP_MOD', category='arithmetic', disabled=True)
OP_LSHIFT               = Opcode(label='OP_LSHIFT', category='arithmetic', disabled=True)
OP_RSHIFT               = Opcode(label='OP_RSHIFT', category='arithmetic', disabled=True)
OP_BOOLAND              = Opcode(label='OP_BOOLAND', category='arithmetic')
OP_BOOLOR               = Opcode(label='OP_BOOLOR', category='arithmetic')
OP_NUMEQUAL             = Opcode(label='OP_NUMEQUAL', category='arithmetic')
OP_NUMEQUALVERIFY       = Opcode(label='OP_NUMEQUALVERIFY', category='arithmetic')
OP_NUMNOTEQUAL          = Opcode(label='OP_NUMNOTEQUAL', category='arithmetic')
OP_LESSTHAN             = Opcode(label='OP_LESSTHAN', category='arithmetic')
OP_GREATERTHAN          = Opcode(label='OP_GREATERTHAN', category='arithmetic')
OP_LESSTHANOREQUAL      = Opcode(label='OP_LESSTHANOREQUAL', category='arithmetic')
OP_GREATERTHANOREQUAL   = Opcode(label='OP_GREATERTHANOREQUAL', category='arithmetic')
OP_MIN                  = Opcode(label='OP_MIN', category='arithmetic')
OP_MAX                  = Opcode(label='OP_MAX', category='arithmetic')
OP_WITHIN               = Opcode(label='OP_WITHIN', category='arithmetic')
